...
impl std::str::FromStr for Opcode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match processed {
            ...
            "FLOATABS" => Ok(Self::FloatAbs), 
            "FLOATADD" => Ok(Self::FloatAdd), 
            "FLOATDIV" => Ok(Self::FloatDiv), 
            "FLOATEQUAL" => Ok(Self::FloatEqual), 
            "FLOATLESS" => Ok(Self::FloatLess), 
            "FLOATLESSEQUAL" => Ok(Self::FloatLessEqual), 
            "FLOATMULT" => Ok(Self::FloatMult), 
            "FLOATNAN" => Ok(Self::FloatNaN), 
            "FLOATNEG" => Ok(Self::FloatNeg), 
            "FLOATNOTEQUAL" => Ok(Self::FloatNotEqual),
            "FLOATSQRT" => Ok(Self::FloatSqrt), 
            "FLOATSUB" => Ok(Self::FloatSub), 
            "FLOOR" => Ok(Self::Floor), 
